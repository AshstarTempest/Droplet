...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      bubbles.forEach((bubble, index) => {
        ...
        (bubble as HTMLElement).style.transform = `translateY(${scrollY * speed}px)`;
      });
    };
  ...
  return (
    <section id="hero" className="relative pt-24 pb-40 overflow-hidden bg-gradient-to-b from-[#E1F5FE] to-white">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 text-center md:text-left animate-on-scroll slide-in-left">
            <div className="inline-block mb-6 px-6 py-2 bg-blue-50 rounded-full">
              <span className="text-[#1A73E8] font-medium">Focus Timer & Productivity</span>
            </div>
            
            <div className="text-reveal animate-on-scroll">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1A73E8] mb-4">
                <span>Turn focus into</span> <span className="relative inline-block">
                  <span>flow</span>
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-lg mx-auto md:mx-0 animate-on-scroll slide-in-left">
              Droplet helps you build productive habits by turning your focus time into beautiful aquatic worlds.
            </p>
            ...
            <div className="mt-8 flex items-center justify-center md:justify-start animate-on-scroll slide-in-up">
              ...
              <div className="ml-2">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#1A73E8]">1000+</span> people already using
                </span>
              </div>
            </div>
          </div>
          
          <div ref={tiltRef} className="md:w-1/2 relative perspective animate-on-scroll slide-in-right tilt-card">
