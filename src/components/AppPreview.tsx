...
const AppPreview: React.FC = () => {
  ...
  return (
    <section id="preview" className="py-20 relative overflow-hidden" ref={sectionRef}>
      {/* Parallax background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white to-[#E1F5FE]"></div>
        <div className="absolute -top-20 right-10 w-64 h-64 rounded-full bg-blue-100 opacity-20 parallax-element" data-speed="0.05"></div>
        <div className="absolute top-40 left-20 w-32 h-32 rounded-full bg-blue-50 opacity-30 parallax-element" data-speed="0.1"></div>
        <div className="absolute bottom-20 right-40 w-48 h-48 rounded-full bg-blue-200 opacity-10 parallax-element" data-speed="0.15"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-on-scroll slide-in-up">
            See how Droplet transforms your productivity with beautiful visual feedback
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {mockupImages.map((mockup, index) => (
            <div 
              key={index} 
              className={`rounded-2xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-xl animate-on-scroll ${index % 2 === 0 ? 'slide-in-left' : 'slide-in-right'}`}
            ...
            >
              ...
              <div className="p-6 bg-white">
                <h3 className="text-xl font-bold mb-2 text-gray-800">{mockup.title}</h3>
        ...
        <div ref={tiltRef} className="mt-16 text-center animate-on-scroll slide-in-up tilt-card inline-block mx-auto">
          <div className="tilt-card-inner">
            <button className="bg-gradient-to-r from-[#FF7043] to-[#FF5722] text-white py-3 px-8 rounded-full text-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl flex items-center group">
              <span>Download Now</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 transition-transform group-hover:translate-y-1">
