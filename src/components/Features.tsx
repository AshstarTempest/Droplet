...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, color, delay }) => {
  return (
    ...
    >
      <div className={`w-14 h-14 rounded-full flex items-center justify-center mb-6 ${color} water-ripple`}>
        {icon}
      </div>
...
const Features: React.FC = () => {
  const features = [
    {
      ...
      title: "Focus Timer",
      description: "Customize focus sessions from 5 to 120 minutes. Each completed session earns water drops.",
      color: "bg-[#1A73E8]"
    },
    {
      icon: <ListChecks className="h-7 w-7 text-white" />,
      title: "Smart To-Do List",
      description: "Organize tasks with priority levels. Earn water drops for each completed task.",
      color: "bg-[#00ACC1]"
    },
    {
      icon: <Droplets className="h-7 w-7 text-white" />,
      title: "Water Drop Rewards",
      description: "Collect water drops to build and expand your virtual aquatic ecosystem.",
      color: "bg-[#1A73E8]"
    },
    {
      icon: <Waves className="h-7 w-7 text-white" />,
      title: "Aquatic Worlds",
      description: "Watch your virtual aquarium grow as you complete tasks and focus sessions.",
      color: "bg-[#00ACC1]"
    }
  ];
  ...
  return (
    <section id="features" className="py-20 relative overflow-hidden bg-gradient-to-b from-[#E1F5FE] to-white">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-on-scroll slide-in-up">
            Droplet transforms productivity into a rewarding experience with these key features
          </p>
        </div>
